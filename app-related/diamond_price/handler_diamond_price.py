...
@app.route('/diamond_price_predict/health_check', methods = ['GET'])
...
# Below chunk is commented out, because even when health check fails (simulated through querying an incorrect table), print(r) returns status code 200
    ...
    try:       
        ...
        return "Health check for diamond price app has completed successfully"
    
    except Exception as e:
        
        exception_msg = "Health check for diamond price app has failed with execption " +str(e)
